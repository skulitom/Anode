...
internal static class AgentGuide
{
    ...
    public const string Instructions =
        ...
        + "renew before expiry, default 120 s; desktop tools fail without it); seat_capabilities for capture/input blockers; seat_run then seat_windows; "
        + "seat_observe + seat_element for accessible controls, seat_wait for delayed UI, seat_screenshot + input tools for visual-only controls, "
        + "seat_exec/seat_job for seat-related builds, tests and servers; close owned windows/jobs; seat_lease action=release. "
    ...
    private const string TestWorkflow =
        ...
        + "Renew with action=renew before it expires (default 120 s, range 10-600 s). If the desktop is busy, wait and retry.\n"
        ...
        + "6. Call seat_lease with action=release.\n\n"
