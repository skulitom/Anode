...
2. Call `seat_capabilities` before relying on screenshots/input. A connection alone is insufficient.
3. Launch an owned app with `seat_run`. Discover its actual window with `seat_windows`.
